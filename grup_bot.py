...
LIMITS_FILE = "limits.json"; USERDATA_FILE = "users.json"
COUNTS_FILE = "counts.json"; IZIN_FILE = "izinler.json"
...
async def buton(_, cb: CallbackQuery):
    ...
    if data == "kapat":
        ...
        await cb.message.edit_text(
            ...
            "📌 `/durumum` → Kendi seviye ve hak durumun\n"
            "🛡️ `/yetkiver @kullanici` → Yetki verir\n"
            "🚫 `/yetkial @kullanici` → Yetki alır\n"
            "ℹ️ `/hakkinda` → Bot bilgisi\n",
